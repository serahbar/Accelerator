...
{
    [DbContext(typeof(AcceleratorDbContext))]
    partial class AcceleratorDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accelerator.Core.Domain.Authors.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthorType = 0,
                            DateOfBirth = new DateTimeOffset(new DateTime(1980, 7, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                            FirstName = "Berry",
                        ...
                        new
                        {
                            ...
                            AuthorType = 0,
                            DateOfBirth = new DateTimeOffset(new DateTime(1978, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                            FirstName = "Nancy",
                        ...
                        new
                        {
                            ...
                            AuthorType = 0,
                            DateOfBirth = new DateTimeOffset(new DateTime(1957, 12, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                            FirstName = "Eli",
                        ...
                        new
                        {
                            ...
                            AuthorType = 0,
                            DateOfBirth = new DateTimeOffset(new DateTime(1957, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                            FirstName = "Arnold",
                        ...
                        new
                        {
                            ...
                            AuthorType = 1,
                            DateOfBirth = new DateTimeOffset(new DateTime(1956, 11, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                            FirstName = "Seabury",
                        ...
                        new
                        {
                            ...
                            AuthorType = 1,
                            DateOfBirth = new DateTimeOffset(new DateTime(1981, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AuthorType = 2,
                            DateOfBirth = new DateTimeOffset(new DateTime(1982, 10, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 30, 0, 0)),
                            FirstName = "Atherton",
            ...
            modelBuilder.Entity("Accelerator.Core.Domain.Courses.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Accelerator.Core.Domain.Courses.Entities.Course", b =>
                {
                    b.HasOne("Accelerator.Core.Domain.Authors.Entities.Author", "Author")
                        .WithMany("Courses")
